...
<html>
  <head>
	...
	-->
<link rel="stylesheet" type="text/css" href="<c:url value='/css/admin/book/desc.css'/>">
<link rel="stylesheet" type="text/css" href="<c:url value='/jquery/jquery.datepick.css'/>">
<script type="text/javascript" src="<c:url value='/jquery/jquery-1.5.1.js'/>"></script>
<script type="text/javascript" src="<c:url value='/jquery/jquery.datepick.js'/>"></script>
<script type="text/javascript" src="<c:url value='/jquery/jquery.datepick-zh-CN.js'/>"></script>

<script type="text/javascript" src="<c:url value='/js/admin/book/desc.js'/>"></script>
...
//修改图书
function updateForm() {
	$("#form").attr("action","/goods/adminBook/updateBook.do");
	$("#form").submit();

}
//删除
function deleteForm() {
	$("#form").attr("action","/goods/adminBook/deleteBook.do");
	$("#form").submit();
}
   ...
   <form action="" method="post" id="form">
    ...
    <div style="float:left;">
		...
		<table class="tab">
			...
			<tr>
				<td colspan="2">
					<input onclick="updateForm()" type="button" name="method" id="editBtn" class="btn" value="编　　辑">
