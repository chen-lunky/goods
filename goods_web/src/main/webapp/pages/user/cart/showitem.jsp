...
<html>
  <head>
	...
	-->
	<link rel="stylesheet" type="text/css" href="<c:url value='/css/user/cart/cart_showitem.css'/>">
...
<script type="text/javascript">
  ...
  <body>
<form id="form1" action="<c:url value='/order/createOrder.do'/>" method="post">
...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td colspan="6">
			<input id="addr" type="text" name="address" value="广州市 番禺区 市良路 办公楼1层  张三"/>
		</td>
	</tr>
	<tr>
