...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="<c:url value='/css/user/book/book_desc.css'/>">
	<script src="<c:url value='/js/user/book/desc.js'/>"></script>
  </head>
  ...
  <div>
    ...
    <div class="divBookDesc">
		...
		<div class="divForm">
			<form id="form1" action="<c:url value='/cart/add.do'/>" method="post">
