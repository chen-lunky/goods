...
<table class="table" align="center">
	<tr class="trTop">
		<td colspan="2" class="tdTop">
			<iframe frameborder="0" src="<c:url value='/pages/user/top.jsp'/>" name="top"></iframe>
		</td>
	</tr>
	<tr>
		...
		<td class="tdSearch" style="border-bottom-width: 0px;">
			<iframe frameborder="0" src="<c:url value='/pages/user/search.jsp'/>" name="search"></iframe>
		</td>
	</tr>
	<tr>
		<td style="border-top-width: 0px;">
			<iframe frameborder="0" src="<c:url value='/pages/user/body.jsp'/>" name="body"></iframe>
		</td>
	</tr>
</table>
  </body>
